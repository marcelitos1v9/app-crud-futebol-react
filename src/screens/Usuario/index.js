...
export default function Usuario() {
  ...
  const navigation = useNavigation();
    ...
    async function loadData() {        
      try {
          const response = await api.get(`marcelo/apiModelo2/usuarios/listar.php?pagina=${page}&limite=10`);
  ...
  async function Search() {
    const response = await api.get(`marcelo/apiModelo/usuarios/buscar.php?buscar=${busca}`);
