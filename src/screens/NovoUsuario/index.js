...
import {AsyncStorage, ScrollView, Platform, Alert, Picker, Text, TextInput, View, TouchableOpacity, ActivityIndicator } from 'react-native';
...
const NovoUsuario= FC= () => {
    ...
    async function saveData() {            
        ...
        try {
            ...
            const res = await api.post('marcelo/apimodelo2/usuarios/salvar.php', obj);
    ...
    async function loadData() {
        ...
        try {
            setLoading(true);
            if (id_reg != "0") {
                const res = await api.get(`marcelo/apiModelo2/usuarios/listar_id.php?id=${id_reg}`);
    ...
    return (
        <View style={{ flex: 1, marginTop: 20 }}>
            ...
            <View>
                <Text style={styles.TitleInputs}>Estrelas</Text>
